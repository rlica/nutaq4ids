...
//Run with:
//   root .x Timing_walk.C


void Timing_walk_La1(){
...
//Define the Run numbers
  const char *Run_name    = "Run025.root";
  TChain ids("ids");
  ids.Add(Run_name);
  //ids.Add("Run047.root");
...
*/
  ...
  const char *plot_Tac_E2 = Form("%s:%s>>(250,1,2000,250,%d,%d)", 
                          Tac, E2, Tac_centroid-Tac_range, Tac_centroid+Tac_range);
